  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="sanate-centro-de-kinesiologia";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Sánate - Centro de Kinesiología y terapias naturales"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="sanate-centro-de-kinesiologia"
      ...
      <body className="font-sans">
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            var pid="sanate-centro-de-kinesiologia";
